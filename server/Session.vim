...
silent only
cd /Volumes/Data/workspaces/monsys
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 main.cc
args /Volumes/Data/workspaces/monsys
edit main.cc
...
exe 'vert 1resize ' . ((&columns * 30 + 122) / 245)
exe '2resize ' . ((&lines * 52 + 32) / 65)
exe 'vert 2resize ' . ((&columns * 214 + 122) / 245)
exe '3resize ' . ((&lines * 10 + 32) / 65)
exe 'vert 3resize ' . ((&columns * 214 + 122) / 245)
argglobal
enew
file /Volumes/Data/workspaces/monsys
let s:cpo_save=&cpo
set cpo&vim
...
lcd /Volumes/Data/workspaces/monsys
wincmd w
argglobal
setlocal autoindent
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 63 - ((24 * winheight(0) + 26) / 52)
